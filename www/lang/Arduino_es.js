...
Blockly.Msg.CAT_ultrason = "👁️‍🗨️ Sensores";
...
Blockly.Msg.inter2=" conectado al pin: ";
...
Blockly.Msg.mc005_tooltip="devuelve cierto o falso según detecte presencia";
Blockly.Msg.bp = "botón presionado en el pin";
Blockly.Msg.bp_tooltip = "devuelve cierto o falso según el botón esté o no presionado (conectado en pullup, ojito)";
...
Blockly.Msg.ultrason = "Conectar sensor de distancias";
...
Blockly.Msg.feu_tooltip = "devuelve cierto o falso si se detecta o no una llama";
Blockly.Msg.presence_tooltip = "devuelve cierto o falso si ha sucedido o no un contacto";
Blockly.Msg.appui_tooltip = "devuelve cierto o falso si el sensor de contacto es activado";
// bluetooth
...
Blockly.Msg.LCD_SHIELD_PRINT_INPUT3 = "línea 3";
Blockly.Msg.LCD_SHIELD_PRINT_INPUT4 = "línea 4";
Blockly.Msg.LCD_ADDRESS="dirección";
Blockly.Msg.LCD_COLUMNS="columnas";
Blockly.Msg.LCD_ROWS="filas";
...
Blockly.Msg.rvb_set_tooltip="muestra el color indicando el valor de cada color entre 0 y 255 para rojo, verde y azulLCD_SHIELD_PRINT_INPUT2";
...
Blockly.Msg.pixel7="encender píxeles";
Blockly.Msg.pixel8="apagar píxeles";
...
// output
Blockly.Msg.ARDUINO_INOUT_DIGITAL_WRITE_INPUT1 = "poner el pin digital nº: ";
...
Blockly.Msg.m_pap="stepper";
Blockly.Msg.m_pap_step="pasos por vuelta";
Blockly.Msg.m_pap_step1="mover adelante";
Blockly.Msg.m_pap_tooltip = "Inicialización de un motor paso a paso (stepper). \nIndique nº de pasos por vuelta, velocidad en rpm y pines a conectar";
...
Blockly.Msg.Serial_Write2 = "escribir línea: ";
Blockly.Msg.Serial_write2_tooltip = "Escribir línea al puerto serie con retorno de carro";
...
Blockly.Msg.SSerial_Write2= "Envía una línea al puerto serie";
Blockly.Msg.SSerial_write2_tooltip = "Envía datos al puerto serie con retorno de carro";
...
Blockly.Msg.MIP="PWM izq.: ";
Blockly.Msg.MDP="PWM der.: ";
Blockly.Msg.MIA="Izq. A: ";
Blockly.Msg.MIB="Izq. B: ";
Blockly.Msg.MDA="Der. A: ";
Blockly.Msg.MDB="Der. B: ";
Blockly.Msg.MASAYLO_STARTPERS_TOOLTIP="Indicar los pines si se ha conectado de modo distinto al requerido por defecto";
...
Blockly.Msg.MASAYLO_MOVE_CHOICE = [["↑ adelante", "FORWARD"], ["↓ atrás", "BACKWARD"], ["↺ giro izquierda", "LEFT"], ["↻ giro derecha", "RIGHT"]];
...
Blockly.Msg.MASAYLO_VELOCIDAD_TEXT="Mover: ";
Blockly.Msg.MASAYLO_VELOCIDAD2_TEXT="a: ";
Blockly.Msg.MASAYLO_USINIT_TEXT="Inicializar sensor US: ";
Blockly.Msg.MASAYLO_US_TOOLTIP="Si quieres medir distancias, necesitas inicializar el sensor de ultrasonidos";

Blockly.Msg.MASAYLO_IRINIT_TEXT="Inicializar sensor IR: ";
Blockly.Msg.MASAYLO_IRLEFT_TEXT="Izquierdo: ";
Blockly.Msg.MASAYLO_IRRIGHT_TEXT="Derecho: ";
Blockly.Msg.MASAYLO_IR_TOOLTIP="Para usar al Masaylo como siguelíneas";
Blockly.Msg.MASAYLO_ENCODERS_TEXT="Activar encoders: ";
Blockly.Msg.MASAYLO_ENCLEFT_TEXT="Izq: ";
Blockly.Msg.MASAYLO_ENCRIGHT_TEXT="Der: ";
Blockly.Msg.MASAYLO_ENCDIAMETER_TEXT="Diámetro: ";
Blockly.Msg.MASAYLO_ENC_TOOLTIP="Usa los encoders para controlar la distancia recorrida";
Blockly.Msg.MASAYLO_SERVOS_TEXT="Inicializar servos: ";
Blockly.Msg.MASAYLO_CABEZA_TEXT="Cabeza: ";
Blockly.Msg.MASAYLO_BRAZO_TEXT="Brazo: ";
Blockly.Msg.MASAYLO_SERVOS_TOOLTIP="Inicializar servos de control de cabeza y brazo";
Blockly.Msg.MASAYLO_ENCODER_VUELTAS_TEXT="Esperar hasta: "
Blockly.Msg.MASAYLO_VUELTAS_TEXT1="Dar: ";
Blockly.Msg.MASAYLO_VUELTAS_TEXT2=" vueltas";
Blockly.Msg.MASAYLO_ENCODER_VUELTAS_TOOLTIP="Controla el número de vueltas que quieres que den las ruedas (debe estar previamente en movimiento)";
Blockly.Msg.MASAYLO_ENCODER_DISTANCIA_TEXT="Seguir así:";
Blockly.Msg.MASAYLO_ENCODER_DISTANCIA_TEXT1="Avanzar: ";
Blockly.Msg.MASAYLO_ENCODER_DISTANCIA_TEXT2=" cm";
Blockly.Msg.MASAYLO_ENCODER_DISTANCIA_TOOLTIP="Puedes controlar (al menos en parte) la distancia que quieres avanzar (debe estar previamente en movimiento)";
Blockly.Msg.MASAYLO_ENCODER_ANGULO_TEXT="Esperar: ";
Blockly.Msg.MASAYLO_ENCODER_ANGULO_TEXT1="º";
Blockly.Msg.MASAYLO_ENCODER_ANGULO_TOOLTIP="Espera hasta que gira las ruedas sólamente el ángulo indicado (debe estar previamente en movimiento)";
Blockly.Msg.MASAYLO_GIRA_CABEZA_TEXT="Girar cabeza";
Blockly.Msg.MASAYLO_GRADOS_TEXT=" º";
Blockly.Msg.MASAYLO_GIRA_CABEZA_TOOLTIP="Puedes girar el servo del sensor de ultrasonidos entre 0 y 180º. La posición central es 90 º";
Blockly.Msg.MASAYLO_GIRA_BRAZO_TEXT="Girar brazo: ";
Blockly.Msg.MASAYLO_GIRA_BRAZO_TOOLTIP="Puedes girar el brazo lateral entre 0 y 180 º. La posición central está en 90 º";
Blockly.Msg.MASAYLO_BUZZER_TEXT="Asignar zumbador al pin: ";
Blockly.Msg.MASAYLO_BUZZER_TOOLTIP="Indica en qué patilla vas a conectar el zumbador";
Blockly.Msg.MASAYLO_PLAYBUZZER_TEXT="Tocar nota: ";
...
Blockly.Msg.RUPERTOBOT_START_TEXT = "Inicio";
Blockly.Msg.RUPERTOBOT_START_TOOLTIP="Declara un nuevo robot de la clase rupertobot";
Blockly.Msg.RUPERTOBOT_URL="https://agomezgar.github.io/rupertobot";
Blockly.Msg.RUPERTOBOT_MODE_CHOICE= [["Débil", "(1)"], ["Fuerte", "(2)"]];
Blockly.Msg.RUPERTOBOT_SPIN_FORWARD="Mover adelante por vueltas: ";
Blockly.Msg.RUPERTOBOT_SPIN_BACKWARD="Mover atrás por vueltas: ";
Blockly.Msg.RUPERTOBOT_SPIN_NUMBER="Nº: ";
Blockly.Msg.RUPERTOBOT_SPIN_TOOLTIP="Indicar número de vueltas y velocidad en rpm"
Blockly.Msg.RUPERTOBOT_SPIN_VELOCITY_TEXT="Velocidad: "
Blockly.Msg.RUPERTOBOT_SPIN_VELOCITY=[["Lento", "5"], ["Intermedio", "10"], ["Rápido", "15"]];
Blockly.Msg.RUPERTOBOT_DISTANCE_FORWARD="Avanzar distancia: ";
Blockly.Msg.RUPERTOBOT_DISTANCE_BACKWARD="Retroceder distancia: ";
Blockly.Msg.RUPERTOBOT_DISTANCE_TEXT="cm ";
Blockly.Msg.RUPERTOBOT_DISTANCE_TOOLTIP="Indicar la distancia en cm ";
Blockly.Msg.RUPERTOBOT_SPIN_LEFT_TOOLTIP="Girar a la izquierda indicando el número de vueltas."
Blockly.Msg.RUPERTOBOT_SPIN_LEFT="Giro a izquierda por vueltas: "
Blockly.Msg.RUPERTOBOT_SPIN_RIGHT_TOOLTIP="Girar a la derecha indicando el número de vueltas."
Blockly.Msg.RUPERTOBOT_SPIN_RIGHT="Giro a derecha por vueltas: "
Blockly.Msg.RUPERTOBOT_GRADES_LEFT_TOOLTIP="Girar a la izquierda indicando el número de grados sexagesimales."
Blockly.Msg.RUPERTOBOT_GRADES_LEFT="Giro a izquierda por grados: "
Blockly.Msg.RUPERTOBOT_GRADES_RIGHT_TOOLTIP="Girar a la derecha indicando el número de grados sexagesimales."
Blockly.Msg.RUPERTOBOT_GRADES_RIGHT="Giro a derecha por grados: "
Blockly.Msg.RUPERTOBOT_IR_TOOLTIP="Para usar al Rupertobot como siguelíneas";
...
Blockly.Msg.ESCORNABOT_APP="Escornabot autónomo";
Blockly.Msg.ESCORNABOT_APP_TOOLTIP="Intenta preparar al escornabot para un funcionamiento autónomo";
Blockly.Msg.ESCORNABOT_APP_URL="www.escornabot.com";
Blockly.Msg.ESCORNABOT_USINIT_TEXT="Inicializar ultrasonidos";
Blockly.Msg.ESCORNABOT_TRIGGER_TEXT="Trigger pin";
Blockly.Msg.ESCORNABOT_ECHO_TEXT="Echo pin";
Blockly.Msg.ESCORNABOT_GETUS_TEXT="Distancia";
Blockly.Msg.ESCORNABOT_GETUS_TOOLTIP="Distancia";
Blockly.Msg.ESCORNABOT_IRINIT_TEXT="Conectar infrarrojos";
Blockly.Msg.ESCORNABOT_IR_TOOLTIP="Inicializar los sensores de infrarrojos";
Blockly.Msg.ESCORNABOT_GETBLACKLEFT_TEXT="Detecto negro a la izquierda";
Blockly.Msg.ESCORNABOT_GETBLACKLEFT_TOOLTIP="Devuelve TRUE si pisa negro por la izquierda";
Blockly.Msg.ESCORNABOT_GETBLACKRIGHT_TEXT="Detecto negro a la derecha";
Blockly.Msg.ESCORNABOT_GETBLACKRIGHT_TOOLTIP="Devuelve TRUE si pisa negro por la derecha";
Blockly.Msg.ESCORNABOT_GETWHITELEFT_TEXT="Detecto blanco a la izquierda";
...
Blockly.Msg.STOCK1="guardar en EEPROM el valor: ";
Blockly.Msg.STOCK2="en dirección :";
Blockly.Msg.STOCK_TOOLTIP="permite guardar un dato en la dirección de la memoria EEPROM especificada";
Blockly.Msg.STOCK3="leer datos EEPROM";
...
Blockly.Msg.matrice8x8_aff_tooltip = "Muestra el símbolo previamente definido";
Blockly.Msg.matrice8x8_efface="Borrar pantalla";
Blockly.Msg.matrice8x8_scroll="Texto deslizante";
Blockly.Msg.matrice8x8_scroll_tooltip="Escribe un texto deslizante en pantalla\n (sólo mayúsculas, 9 caracteres)";
Blockly.Msg.rvb_red="rojo";
Blockly.Msg.rvb_green="verde";
Blockly.Msg.rvb_blue="azul";