#include "Arduino.h"
#include "Encoder.h"
    Encoder::Encoder(int pinEncoderI, int pinEncoderD, int dia) {//constructor del objeto encoder, se ejecuta cuando se crea el objeto, se le pasa parámetros de pin sensor izdo, pin sensor dcho y diámetro de rueda
     intPinI=pinEncoderI;
     intPinD=pinEncoderD;
     diametro=dia;
     ISRCounterI=0;
